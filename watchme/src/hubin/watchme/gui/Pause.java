...
public class Pause extends FollowAppAction
{
	...
	public Pause(WatchMeMain app)
	{
		// false is passed into getIcon(..) because a file follower never
		// starts in a paused state
		super(app, WatchMeMain.getResourceString("action.Pause.name"),
				WatchMeMain.getResourceString("action.Pause.mnemonic"),
				WatchMeMain.getResourceString("action.Pause.accelerator"),
				WatchMeMain.getIcon(Pause.class, getIconName(false)),
	...
	public void setIconByState(boolean paused)
	{
		...
		ImageIcon icon = WatchMeMain.getIcon(Pause.class, Pause.getIconName(paused));
