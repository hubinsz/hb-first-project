...
public class ClearAll extends FollowAppAction
{
	...
	public ClearAll(WatchMeMain app) throws IOException
	{
		super(app, WatchMeMain.getResourceString("action.ClearAll.name"),
				WatchMeMain.getResourceString("action.ClearAll.mnemonic"),
				WatchMeMain.getResourceString("action.ClearAll.accelerator"),
				WatchMeMain.getIcon(ClearAll.class, "action.ClearAll.icon"),
