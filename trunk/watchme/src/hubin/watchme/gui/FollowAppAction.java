...
import hubin.watchme.InvalidVkException;
...
public abstract class FollowAppAction extends AbstractAction
{
	...
	private WatchMeMain app;
	private int mnemonic;
	private KeyStroke accelerator;
	private ActionContext context;

	public FollowAppAction(WatchMeMain app, String name, String mnemonic, String accelerator,
			ActionContext type)
	{
		super(name);
	...
	public WatchMeMain getApp()
	{
		return app;
	}

	private void init(WatchMeMain app, String mnemonic, String accelerator, ActionContext type)
	{
		this.app = app;
		context = type;
		try
