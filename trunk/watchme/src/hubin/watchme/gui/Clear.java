...
public class Clear extends FollowAppAction
{
	...
	public Clear(WatchMeMain app) throws IOException
	{
		super(app, WatchMeMain.getResourceString("action.Clear.name"),
				WatchMeMain.getResourceString("action.Clear.mnemonic"),
				WatchMeMain.getResourceString("action.Clear.accelerator"),
				WatchMeMain.getIcon(Clear.class, "action.Clear.icon"),
