...
public class FindDialog extends JDialog {
	...
	public FindDialog(Find find) {
		super(find.getApp().getFrame(), WatchMeMain
		...
		//
		gbc.ipadx = 4;
		findPanel.add(new JLabel(WatchMeMain
		...
		//
		caseSensitive = new JCheckBox(WatchMeMain
		...
		//
		regEx = new JCheckBox(WatchMeMain
		...
		// add the find button
		//
		findButton = new JButton(WatchMeMain
				.getResourceString("dialog.Find.findButton.label"));
		findButton.setMnemonic(WatchMeMain.getResourceString(
		...
		clearButton = new JButton(WatchMeMain
				.getResourceString("dialog.Find.clearButton.label"));
		clearButton.setMnemonic(WatchMeMain.getResourceString(
		...
		closeButton = new JButton(WatchMeMain
				.getResourceString("dialog.Find.closeButton.label"));
		closeButton.setMnemonic(WatchMeMain.getResourceString(
